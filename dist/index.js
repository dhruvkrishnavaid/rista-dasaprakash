...
app.get('/branches', function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var response, data, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, axios_1.default.get('https://api.ristaapps.com/v1/branch/list', {
                        headers: {
                            'x-api-key': apiKey,
                            'x-api-token': token,
                            'content-type': 'application/json'
            ...
            case 2:
                ...
                res.status(500).json({ error: 'Internal Server Error', msg: error_1 });
                return [3 /*break*/, 3];
